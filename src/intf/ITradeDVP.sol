...
interface ITradeDVP {
  ...
  event NotifyTradeDVP(address indexed seller, address indexed buyer, Status indexed status, uint256 quantity, uint256 price, bytes8 paymentID, bytes metadata);
}